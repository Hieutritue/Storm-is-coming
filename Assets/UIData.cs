...
public class UIData : MonoBehaviour
{
    ...
    private void Start()
    {
        _image.DOFade(0, 1).SetEase(Ease.InSine).SetUpdate(true).OnComplete(() => Destroy(_image.gameObject));
    }
    ...
    private void Update()
    {
        ...
        _men.text = (GameManager.Instance.UnitManager.AllAllies.Count - 1) + "/" +
                    GameManager.Instance.UnitManager.Capacity;
        ...
        _nextWave.text = "Next wave in " + (GameManager.Instance.TimeLineManager.EventWeeks[0].Week -
                                            GameManager.Instance.TimeLineManager.CurrentWeek) + " weeks";
    }
